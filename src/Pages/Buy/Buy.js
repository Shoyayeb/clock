...
const Buy = () => {
    ...
    useEffect(() => {
        const url = `https://o-clock.herokuapp.com/product/${productId}`;
    ...
    const handleBookService = (e) => {
        ...
        formData.clockName = foodData.foodname;
        formData.serviceName = foodData.serviceName;
        formData.active = true;
        formData.price = foodData.servicePrice;
        axios
            .post("https://o-clock.herokuapp.com/order", formData)
            .then(function (res) {
                setOrdered(true);
            })
    ...
    return (
        <div>
            ...
            <Transition.Root show={ordered} as={Fragment}>
                <Dialog
                    as="div"
