import { ChartSquareBarIcon, ClockIcon, MenuIcon, XIcon } from '@heroicons/react/outline';
...
const DashBoardNavBar = () => {
    ...
    return (
        <div>
            <div className="rounded-r bg-gray-300 xl:hidden flex justify-between w-full p-6 items-center ">
                <div className="flex justify-between  items-center space-x-3">
                    <img src={LogoImage} width={34} height={34} alt="" />
                    <p className="text-2xl leading-6 text-gray-700">O'clock</p>
                </div>
            ...
            <div id="Main" className={`${show ? 'translate-x-0' : '-translate-x-full'} xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-gray-300 flex-col`}>
                <div className="hidden xl:flex justify-start p-6 items-center space-x-3">
                    <img src={LogoImage} width={34} height={34} alt="" />
                    <p className="text-2xl leading-6 text-gray-700">O'clock</p>
                </div>
                <div className="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
                    <Link to="/dashboard" className="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-gray-400  text-gray-700 rounded ">
                        <ChartSquareBarIcon width={24} height={24} />
                        <p className="text-base leading-4 ">Dashboard</p>
                    </Link>
                    <Link to="/dashboard" className="flex jusitfy-start items-center w-full  space-x-6 focus:outline-none text-gray-700 focus:text-gray-400   rounded ">
                        <ClockIcon width={24} height={24} />
                        <p className="text-base leading-4 ">My Orders</p>
                    </Link>
                </div>
                <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
                    <button onClick={() => setMenuValue(0)} className="focus:outline-none focus:text-indigo-400  text-gray-700 flex justify-between items-center w-full py-5 space-x-14  ">
                    ...
                    <div id="menu1" className={`${menu[0] ? 'flex' : 'hidden'} justify-start  flex-col w-full md:w-auto items-start pb-1 `}>
                        <button className="flex justify-start items-center space-x-6 hover:text-gray-800  focus:text-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                        ...
                        <button className="flex justify-start items-center space-x-6 hover:text-gray-800  focus:text-gray-700 hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
                    <button onClick={() => setMenuValue(1)} className="focus:outline-none focus:text-indigo-400  text-gray-700 flex justify-between items-center w-full py-5 space-x-14  ">
                ...
                <div className="flex flex-col justify-between items-center h-full pb-6   px-6  w-full  space-y-32 ">
                    <button onClick={() => setMenuValue(2)} className="focus:outline-none focus:text-indigo-400  text-gray-700 flex justify-between items-center w-full py-5 space-x-14  ">
                    ...
                    <div className="hidden flex justify-start flex-col items-start pb-5 ">
                        <button className="flex justify-start items-center space-x-6 hover:text-gray-800  focus:text-gray-700 hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-52">
                            <svg className="fill-stroke" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15 10L11 14L17 20L21 4L3 11L7 13L9 19L12 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            <p className="text-base leading-4  ">Messages</p>
                    ...
                    <div className=" flex justify-between items-center w-full">
                        <div className="flex justify-center items-center  space-x-2">
                            ...
                            <div className="flex justify-start flex-col items-start">
                                <p className="cursor-pointer text-sm leading-5 text-gray-700">Alexis Enache</p>
